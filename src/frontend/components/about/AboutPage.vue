            ...
            <div v-if="appInfo" class="bg-white rounded shadow">
                ...
                <div class="divide-y text-gray-900">
                    ...
                    <div class="flex p-1">
                        <div class="mr-auto">
                            <div>Versions</div>
                            <div class="text-sm text-gray-700">RLink v{{ appInfo.version }} • RNS v{{ appInfo.rns_version }} • LXMF v{{ appInfo.lxmf_version }}</div>
                        </div>
                        <div class="hidden sm:block mx-2 my-auto">
                            <a target="_blank" href="https://github.com/ReserveNetwork/r-link/releases" type="button" class="my-auto inline-flex items-center gap-x-1 rounded-md bg-gray-500 px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">
                                Check for Updates
                            </a>
                        </div>
                    </div>
